            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="home.php" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">Verificar pontos registrados</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Verificar pontos registrados</h5>
                    <p class="text-center small">Para verficar os pontos registrados escolha as opções de filtrar por funcionário ou por data</p>
                  </div>

                  <form class="row g-3 needs-validation">
                    <div class="col-12">
                    <a href="ffuncionario.php"><input class="btn btn-primary w-100" type='button' value='Filtrar por funcionário'></a>
                      <br> <br>
                      <a href="dfuncionario.php"><input class="btn btn-primary w-100" type='button' value='Filtrar por data'></a>
                      <br> <br>
