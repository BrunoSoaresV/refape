          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="verificarpontos.php" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Para listar os pontos registrados insira a CTPS do funcionário</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="lfponto.php" name="listagem" enctype='multipart/form-data'>
			                <div class="col-12">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" onclick="document.frmlfponto.submit();">Buscar</button>
                      <br> <br>
