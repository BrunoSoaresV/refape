              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="e1.php" name="edicao" enctype='multipart/form-data'>
                    ...
                    <?php
                    $sql = "SELECT * FROM refape_web.funcionario WHERE email_empresa='$email_empresa' and ctps='$ctps' ;";
                    $resultado=pg_query($conexao, $sql);
                    ...
                    if($linha){
                      ...
                      if ($status=='f'){
                      echo '<input type="radio" name="s" placeholder="Status" value="true" id="s" checked required><label for="true">&nbsp;Ativado</label><br>
                      ...
                      <input type="radio" name="s" placeholder="Status" value="false"  id="s" checked required><label for="false">&nbsp;Desativado</label>';
                    }
                  }
                     ?>
